import type { ASCIISymbol, LowercaseChars, UppercaseChars } from '../helpers/constant'
 ...
 * 内部转换规则
 */
type _SnakeCase<Str extends string> = 
 ...
 * >>> 'foo_bar'
 */
export type SnakeCase<Str extends string> = TrimEnd<ToLower<_SnakeCase<Str>>, Delimiter>