 ...
 * 内部转换规则
 */
type _KebabCase<Str extends string> = 
 ...
 * >>> 'foo_bar'
 */
export type KebabCase<Str extends string> = TrimEnd<ToLower<_KebabCase<Str>>, '-'>