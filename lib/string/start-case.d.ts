 ...
 * 内部转换规则
 */
type _StartCase<Str extends string> = 
 ...
 * >>> 'FOO BAR'
 */
export type StartCase<Str extends string> = UpperFirst<TrimEnd<_StartCase<Str>>>